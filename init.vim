...
if exists('g:vscode')
  ...
  nnoremap <leader>l <Cmd>call VSCodeNotify('editor.unfold')<CR>
  nnoremap <leader>j <Cmd>call VSCodeNotify('editor.foldRecursively')<CR>j
  nnoremap <leader>k <Cmd>call VSCodeNotify('editor.unfoldAll')<CR>
  ...
  nnoremap <leader><BS>fr <Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex6')<CR><Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex5')<CR><Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex4')<CR><Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex3')<CR><Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex2')<CR><Cmd>call VSCodeNotify('workbench.action.openEditorAtIndex1')<CR>
  nnoremap <leader>fa <Cmd>call VSCodeNotify('workbench.action.pinEditor')<CR>
  nnoremap <leader>fd <Cmd>call VSCodeNotify('workbench.action.unpinEditor')<CR>
  nnoremap <leader>sv <Cmd>call VSCodeNotify('workbench.action.reloadWindow')<CR>
  nnoremap <leader>z <Cmd>call VSCodeNotify('workbench.action.toggleZenMode')<CR>
  nnoremap <leader>a <Cmd>call VSCodeNotify('workbench.action.toggleSidebarVisibility')<CR>
  nnoremap <leader>t <Cmd>call VSCodeNotify('workbench.action.togglePanel')<CR>
  nnoremap <leader>ct <Cmd>call VSCodeNotify('workbench.action.quickOpenTerm')<CR>
endif
" Change Comment String for Cpp
autocmd FileType c,cpp,java,keymap setl commentstring=//\ %s
autocmd FileType py,robot,ipynb setl commentstring=#\ %s
...
" nnoremap F5 !devbuild2<cr>

augroup highlight_yank
  autocmd!
  autocmd TextYankPost * silent! lua require'vim.highlight'.on_yank({timeout = 40})
augroup END
nnoremap <leader>wip :! git stage .;git commit -m "wip";git push<CR>
